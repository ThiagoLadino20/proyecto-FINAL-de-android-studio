...
void simulateMatches() {
    ...
    vector<string> equipos = {"Equipo A1", "Equipo A2", "Equipo A3", "Equipo A4",
                              "Equipo B1", "Equipo B2", "Equipo B3", "Equipo B4",
                              "Equipo C1", "Equipo C2", "Equipo C3", "Equipo C4",
                              "Equipo D1", "Equipo D2", "Equipo D3", "Equipo D4"};
    ...
    cout << "\n¡El ganador de la Copa America es: " << ganador << "!" << endl;
}

void cargarEstadios() {
    vector<Stadium> stadiums = {
        {"Stadium 1", {{"Argentina", "Team 2", 0, 0, "2024-05-01"}, {"Team 3", "Team 4", 0, 0, "2024-05-02"}, {"Team 5", "Team 6", 0, 0, "2024-05-03"}}},
        {"Stadium 2", {{"Team 7", "Team 8", 0, 0, "2024-05-04"}, {"Team 9", "Team 10", 0, 0, "2024-05-05"}, {"Team 11", "Team 12", 0, 0, "2024-05-06"}}},
        {"Stadium 3", {{"Team 13", "Team 14", 0, 0, "2024-05-07"}, {"Team 15", "Team 16", 0, 0, "2024-05-08"}, {"Team 17", "Team 18", 0, 0, "2024-05-09"}}},
...
int main() {
    int opcion;
    cout << "Bienvenido a la Copa America" << endl;
