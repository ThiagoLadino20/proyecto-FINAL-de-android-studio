...
public class maps extends AppCompatActivity implements OnMapReadyCallback, GoogleMap.OnMapClickListener, GoogleMap.OnMapLongClickListener {
    ...
    public void onMapReady(@NonNull GoogleMap googleMap) {
        ...
        LatLng bogota = new LatLng(4.6531925,-74.147785);
        mMap.addMarker(new MarkerOptions().position(bogota).title("Bogota"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(bogota));

        LatLng hipona = new LatLng(4.7382199,-74.085235816);
        mMap.addMarker(new MarkerOptions().position(bogota).title("Hipona"));
        mMap.moveCamera(CameraUpdateFactory.newLatLng(hipona));
    }
